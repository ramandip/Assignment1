...
public class enemyScriptBrown : MonoBehaviour
{

    public float speed_brown = 0.08f;
    public float x, y;
    ...
    void Update()
    {
        ...
        Vector3 velocity = new Vector3(0, speed_brown, 0);//Hard code speed  value is inserted.
        pos -= velocity;
